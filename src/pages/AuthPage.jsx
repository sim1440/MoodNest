...
const styles = {
  ...
  logoDot: { width: 10, height: 10, borderRadius: '50%', background: '#E8B4A0' },
  taglineH1: {
    fontFamily: "'Playfair Display', serif",
  ...
  previewTitle: { fontSize: 13, fontWeight: 500, color: 'rgba(255,255,255,0.8)' },
  previewDate: { fontSize: 11, color: 'rgba(255,255,255,0.3)' },
  ...
  tabs: {
    display: 'flex', background: 'rgba(45,49,66,0.07)',
  ...
  tab: {
    ...
    color: '#2D3142', opacity: 0.5, cursor: 'pointer',
    transition: 'all 0.2s', fontFamily: "'DM Sans', sans-serif",
  },
  tabActive: {
    background: '#fff', opacity: 1, fontWeight: 500,
    boxShadow: '0 1px 4px rgba(45,49,66,0.1)',
  },
  formTitle: {
    fontFamily: "'Playfair Display', serif",
    fontSize: 28, fontWeight: 600, color: '#2D3142', marginBottom: 8,
  },
  formSub: {
    fontSize: 14, fontWeight: 300, color: '#2D3142',
    opacity: 0.55, marginBottom: 28, lineHeight: 1.6,
  },
  form: { display: 'flex', flexDirection: 'column', gap: 16 },
  field: { display: 'flex', flexDirection: 'column', gap: 6 },
  label: { fontSize: 13, fontWeight: 500, color: '#2D3142', opacity: 0.7 },
  input: {
    padding: '12px 14px', borderRadius: 10,
    border: '1px solid rgba(45,49,66,0.15)',
    background: '#fff', fontSize: 14, color: '#2D3142',
    outline: 'none', fontFamily: "'DM Sans', sans-serif", transition: 'border 0.2s',
  },
  forgotLink: { fontSize: 12, color: '#7B9E87', textDecoration: 'none' },
  submitBtn: {
    padding: '13px', borderRadius: 26, border: 'none',
    color: '#fff', fontSize: 14, fontWeight: 500, cursor: 'pointer',
    marginTop: 4, fontFamily: "'DM Sans', sans-serif", transition: 'background 0.2s',
  },
  successMsg: {
    background: 'rgba(123,158,135,0.12)',
    border: '1px solid rgba(123,158,135,0.3)',
    borderRadius: 10, padding: '12px 14px',
    fontSize: 13, color: '#4A6741', textAlign: 'center',
  },
  switchText: {
    fontSize: 13, color: '#2D3142', opacity: 0.6,
    textAlign: 'center', marginTop: 24,
  },
  switchLink: { color: '#7B9E87', fontWeight: 500, cursor: 'pointer' },
}