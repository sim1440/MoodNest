...
const initialTasks = [
  { id: 1, text: 'Review project proposal', priority: 'high', done: false, time: '9:00 AM' },
  { id: 2, text: 'Morning journaling', priority: 'medium', done: true, time: '7:30 AM' },
  { id: 3, text: 'Team standup meeting', priority: 'high', done: false, time: '10:00 AM' },
  { id: 4, text: 'Take a 15 min walk', priority: 'low', done: false, time: '1:00 PM' },
  { id: 5, text: 'Read for 20 minutes', priority: 'low', done: true, time: '8:00 PM' },
]
...
export default function Dashboard() {
  ...
  const handleCheckin = () => {
    if (moodNote.trim() || selectedMood !== null) {
      setCheckedIn(true)
    }
  }
    ...
    <div style={styles.page}>
      ...
      <div style={styles.main}>
        ...
        <div style={styles.topBar}>
          <div>
            <h1 style={styles.pageTitle}>Good morning, Harsimran 🌿</h1>
          ...
          <div style={styles.leftCol}>
            ...
            <div style={styles.card}>
              ...
              <button
                style={{
                  ...styles.checkinBtn,
                  background: checkedIn ? '#7B9E87' : '#2D3142',
                }}
            ...
            <div style={{ ...styles.card, background: '#2D3142' }}>
              ...
              <p style={styles.insightText}>
                Based on your patterns, you tend to feel most productive on <strong style={{ color: '#7B9E87' }}>Wednesday and Saturday mornings</strong>. Consider scheduling important tasks during these windows. Your mood has been trending upward this week — keep it up! 🌱
              </p>
              <button
...
const styles = {
  ...
  sidebarLogo: {
    ...
    color: '#4A6741', display: 'flex', alignItems: 'center', gap: 8, marginBottom: 36,
    paddingLeft: 8,
  },
  ...
  streakBadge: {
    background: 'rgba(232,180,160,0.2)', border: '1px solid rgba(232,180,160,0.4)',
    borderRadius: 20, padding: '6px 14px', fontSize: 13, fontWeight: 500, color: '#C0663A',
  },
  ...
  moodChip: {
    flex: 1, borderRadius: 12, padding: '12px 4px', textAlign: 'center',
    cursor: 'pointer', transition: 'all 0.2s',
  },
  moodLabel: { display: 'block', fontSize: 10, fontWeight: 500, color: '#2D3142', opacity: 0.6, marginTop: 4 },
  moodNote: {
    width: '100%', borderRadius: 10, border: '1px solid rgba(45,49,66,0.12)',
    padding: '10px 12px', fontSize: 13, fontFamily: "'DM Sans', sans-serif",
    color: '#2D3142', resize: 'none', outline: 'none', marginBottom: 12,
    background: '#F7F3EE',
  },
  checkinBtn: {
    width: '100%', padding: '11px', borderRadius: 24, border: 'none',
  ...
  moodLegend: { display: 'flex', gap: 12, flexWrap: 'wrap' },
  legendItem: { display: 'flex', alignItems: 'center', gap: 4 },
  legendDot: { width: 8, height: 8, borderRadius: '50%' },
  legendLabel: { fontSize: 11, color: '#2D3142', opacity: 0.6 },
  ...
  chatBtn: {
    background: 'rgba(123,158,135,0.2)', border: '1px solid rgba(123,158,135,0.3)',
    color: '#7B9E87', padding: '9px 16px', borderRadius: 20, fontSize: 13,
  ...
  taskInput: {
    ...
    border: '1px solid rgba(45,49,66,0.12)', fontSize: 13,
    fontFamily: "'DM Sans', sans-serif", color: '#2D3142', outline: 'none',
    background: '#F7F3EE',
  },
  prioritySelect: {
    padding: '9px 8px', borderRadius: 10, border: '1px solid rgba(45,49,66,0.12)',
    fontSize: 12, fontFamily: "'DM Sans', sans-serif", color: '#2D3142',
    background: '#F7F3EE', outline: 'none',
  },
  addBtn: {
    width: 36, height: 36, borderRadius: 10, border: 'none',
    background: '#2D3142', color: '#fff', fontSize: 20, cursor: 'pointer',
  ...
  taskItem: {
    ...
    borderRadius: 12, background: '#F7F3EE', transition: 'opacity 0.3s',
  },
  taskCheck: {
  ...
  deleteBtn: {
    fontSize: 16, color: '#2D3142', opacity: 0.25, cursor: 'pointer',
    lineHeight: 1, paddingTop: 2, transition: 'opacity 0.2s',
  },
}