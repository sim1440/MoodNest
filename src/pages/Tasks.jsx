...
const initialTasks = [
  { id: 1, text: 'Review project proposal', priority: 'high', done: false, time: '9:00 AM', category: 'Work', due: 'Today' },
  { id: 2, text: 'Morning journaling', priority: 'medium', done: true, time: '7:30 AM', category: 'Wellness', due: 'Today' },
  { id: 3, text: 'Team standup meeting', priority: 'high', done: false, time: '10:00 AM', category: 'Work', due: 'Today' },
  { id: 4, text: 'Take a 15 min walk', priority: 'low', done: false, time: '1:00 PM', category: 'Wellness', due: 'Today' },
  { id: 5, text: 'Read for 20 minutes', priority: 'low', done: true, time: '8:00 PM', category: 'Personal', due: 'Today' },
  { id: 6, text: 'Prepare weekly report', priority: 'high', done: false, time: '3:00 PM', category: 'Work', due: 'Tomorrow' },
  { id: 7, text: 'Grocery shopping', priority: 'medium', done: false, time: '5:00 PM', category: 'Personal', due: 'Tomorrow' },
  { id: 8, text: 'Meditation session', priority: 'medium', done: false, time: '7:00 AM', category: 'Wellness', due: 'Tomorrow' },
]
...
export default function Tasks() {
  ...
  const todayTasks = filtered.filter(t => t.due === 'Today')
  ...
  const TaskItem = ({ task }) => (
    <div style={{
      ...
      borderLeft: `3px solid ${task.done ? '#ccc' : priorityColor[task.priority].text}`,
    }}>
      <div
        style={{
          ...styles.taskCheck,
          background: task.done ? '#7B9E87' : 'transparent',
          borderColor: task.done ? '#7B9E87' : 'rgba(45,49,66,0.2)',
        }}
      ...
      <div style={styles.taskBody}>
        ...
        <div style={styles.taskMeta}>
          ...
          <span style={{
            ...styles.badge,
            background: categoryColor[task.category].bg,
      ...
      <div style={styles.main}>
        ...
        <div style={styles.topBar}>
          <div>
            ...
            <p style={styles.pageDate}>Sunday, March 22, 2026</p>
          </div>
        ...
        <div style={styles.statsRow}>
          {[
            ...
            { label: 'Completion rate', value: `${Math.round((doneTasks / totalTasks) * 100)}%` },
          ].map((s, i) => (
        ...
        <div style={styles.progressCard}>
          <div style={styles.progressHeader}>
            ...
            <span style={styles.progressPct}>{Math.round((doneTasks / totalTasks) * 100)}% complete</span>
          </div>
          ...
          <div style={styles.filterGroup}>
            {categories.map(c => (
              <button
                ...
                style={{
                  ...styles.filterBtn,
                  background: filter === c ? '#2D3142' : 'transparent',
                  color: filter === c ? '#fff' : '#2D3142',
                  opacity: filter === c ? 1 : 0.5,
                }}
                onClick={() => setFilter(c)}
              >
                {c}
          ...
          <div style={styles.filterGroup}>
            {priorities.map(p => (
              <button
                ...
                style={{
                  ...styles.filterBtn,
                  background: priorityFilter === p ? '#2D3142' : 'transparent',
                  color: priorityFilter === p ? '#fff' : '#2D3142',
        ...
        <div style={styles.taskSections}>
          ...
          {filtered.length === 0 && (
            <div style={styles.emptyState}>
              ...
              <button style={styles.emptyBtn} onClick={() => { setFilter('All'); setPriorityFilter('all') }}>
                Clear filters
              </button>
            </div>
          )}
...
const styles = {
  ...
  addBtn: {
    background: '#2D3142', color: '#fff', padding: '10px 20px', borderRadius: 24,
  ...
  addForm: {
    ...
    border: '1px solid rgba(45,49,66,0.1)', marginBottom: 20,
  },
  ...
  addInput: {
    ...
    background: '#F7F3EE', marginBottom: 12,
  },
  addFormRow: { display: 'flex', gap: 8, flexWrap: 'wrap', alignItems: 'center' },
  select: {
    padding: '9px 10px', borderRadius: 10, border: '1px solid rgba(45,49,66,0.12)',
    fontSize: 12, fontFamily: "'DM Sans', sans-serif", color: '#2D3142',
    background: '#F7F3EE', outline: 'none', cursor: 'pointer',
  },
  saveBtn: {
    background: '#2D3142', color: '#fff', padding: '9px 18px', borderRadius: 20,
    border: 'none', fontSize: 13, cursor: 'pointer', fontFamily: "'DM Sans', sans-serif",
  },
  cancelBtn: {
    background: 'transparent', color: '#2D3142', padding: '9px 14px', borderRadius: 20,
    border: '1px solid rgba(45,49,66,0.15)', fontSize: 13, cursor: 'pointer',
  ...
  filterBtn: {
    padding: '7px 14px', borderRadius: 9, border: 'none', fontSize: 12,
  ...
  taskItem: {
    ...
    borderRadius: 12, background: '#fff', border: '1px solid rgba(45,49,66,0.06)',
  ...
  emptyBtn: {
    background: '#2D3142', color: '#fff', padding: '10px 20px', borderRadius: 20,
    border: 'none', fontSize: 13, cursor: 'pointer', fontFamily: "'DM Sans', sans-serif",
  },
}